...
assert.match(evaluationSource, /\.evaluation-page\s*\{\s*\n\s*height:\s*100vh/s, 'evaluation page should create a viewport scroll container')
assert.match(evaluationSource, /\.evaluation-page\s*\{[^}]*overflow-y:\s*auto/s, 'evaluation page should allow vertical scrolling')
